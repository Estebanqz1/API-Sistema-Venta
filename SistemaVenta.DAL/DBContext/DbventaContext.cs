...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CFFF74FA6");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FADF10DD0");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4836625958C");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A48FF92FF8");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A8164F9DB");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13263111A1F");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F766D31A689");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6BA6AC776");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56145A1E56F2");
